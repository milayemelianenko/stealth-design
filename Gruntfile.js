    ...
    grunt.initConfig({
        ...
        browserSync: {
            dev: {
                ...
                options: {
                    watchTask: true,
                    proxy: "http://localhost/stealth-design"
                }
            }
        },
        tinypng: {
            ...
            my_target: {
                files: {
                    'assets/js/vendor.js': [
                        ...
                        'assets/js/libraries/popper.min.js',                     
                        ...
                        // 'assets/js/libraries/select2.min.js',
                        'assets/js/libraries/wow.min.js',
                        'assets/js/libraries/imagesloaded.js',
                        'assets/js/libraries/masonry.pkgd.min.js',
